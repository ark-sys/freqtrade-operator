...
// +kubebuilder:deprecatedversion:warning="freqtrade.io/v1alpha1 FreqUI is deprecated; use freqtrade.io/v1beta1. See https://github.com/ark-sys/freqtrade-operator#upgrading-to-v1beta1"
